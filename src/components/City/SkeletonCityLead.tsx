...
const SkeletonCityLead = () => {
    ...
    const renderHoursSkeleton = (count: number) : JSX.Element[] => {
        ...
        const renderHour = () => {
            return (
                <>
                    <rect x={Canvas.HOUR_INIT_X + Canvas.HOUR_GAP_X * (count - 1)} y={Canvas.HOUR_INIT_Y + 60} rx="5" ry="2" width="25"
                          height="20"/>
                    <rect x={Canvas.HOUR_INIT_X - 10 + Canvas.HOUR_GAP_X * (count - 1)} y={(Canvas.HOUR_INIT_Y + 60) + Canvas.HOUR_GAP_Y}
                          rx="5" ry="2" width="45" height="20"/>
                    <rect x={Canvas.HOUR_INIT_X + Canvas.HOUR_GAP_X * (count - 1)} y={(Canvas.HOUR_INIT_Y + 60) + Canvas.HOUR_GAP_Y * 2}
                          rx="5" ry="2" width="25" height="20"/>
                </>
            )
        }
        ...
        return renderHoursSkeleton(--count)
    }
    ...
    const renderWeekSkeleton = (count: number): JSX.Element[] => {
        ...
        const renderDay = () => {
            ...
            return (
                <>
                    <rect x={Canvas.DAY_INIT_X} y={Canvas.DAY_INIT_Y + 55 + (Canvas.DAY_GAP_Y * (count - 1))} rx="5" ry="2" width={randomWidth < 60 ? 60 : randomWidth}
                          height="20"/>
                    <rect x={Canvas.DAY_INIT_X + 480} y={Canvas.DAY_INIT_Y + 55 + (Canvas.DAY_GAP_Y * (count - 1))}
                          rx="5" ry="2" width="45" height="20"/>
                    <rect x={Canvas.WIDTH - 120} y={Canvas.DAY_INIT_Y + 55 + (Canvas.DAY_GAP_Y * (count - 1))}
                          rx="5" ry="2" width="120" height="20"/>
                </>
            )
        }
        ...
        return renderWeekSkeleton(--count)
    }
